                                    ...
                                    <tbody>
                                        <tr>
                                           <?php for ($i=7;$i<=12;$i++) {                                            
                                            $rectIndex = $i*2;                                            
                                            echo('<td>'.
                                                '<a href="javascript:void(0)" onclick="addSchedule(this,'.$arrDays[$indDays][1].',\''.($i<11?'0'.$i:$i).':00\')"><div class="table_rect '.($arrSlots[$rectIndex]==1?'yellow':'green').'"></div></a>'.
                                                '<a href="javascript:void(0)" onclick="addSchedule(this,'.$arrDays[$indDays][1].',\''.($i<11?'0'.$i:$i).':30\')"><div class="table_rect '.($arrSlots[$rectIndex+1]==1?'yellow':'green').'"></div></a>'.
                                            '</td>');
                                          }?>                                            
                                          <?php for ($i=1;$i<=12;$i++) { 
                                             $rectIndex = ($i+12)*2;
                                           ...
                                           <?php for ($i=1;$i<=6;$i++) { 
                                             $rectIndex = $i*2;     
                                             echo('<td>'.
                                                '<a href="javascript:void(0)" onclick="addSchedule(this,'.$arrDays[$indDays][1].',\''.$i.':00\')"><div class="table_rect '.($arrSlots[$rectIndex]==1?'yellow':'green').'"></div></a>'.
                                                '<a href="javascript:void(0)" onclick="addSchedule(this,'.$arrDays[$indDays][1].',\''.$i.':30\')"><div class="table_rect '.($arrSlots[$rectIndex+1]==1?'yellow':'green').'"></div></a>'.
                                            '</td>');
                                          }?> 
                                        </tr>
                                    </tbody>
